...
time1 =Time.new
  ...
  #f.puts("______________________________________________________________________________________________________________")
   f.puts("\""+params[:comentario].to_s+"\"")

  f.puts("\n")
  
  f.puts("Autor: "+params[:autor].to_s+"       "+"Fecha de publicación :"+time1.year.to_s+"/"+time1.month.to_s+"/"+time1.day.to_s+"  "+time1.hour.to_s+":"+time1.min.to_s+":"+time1.sec.to_s)
   f.puts("\n")
